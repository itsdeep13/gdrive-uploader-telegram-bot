...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '1829318872:AAHPKJL75whNERBhnFkXEWEpSgkbkmZx3aA' # Get it from https://t.me/BotFather
    APP_ID = '3498045' # Get it from my.telegram.org/apps
    API_HASH = '229441a8b355de58ba025be657c82ea3' # Get it from my.telegram.org/apps
    DATABASE_URL = 'postgres://qlzfjjuxfoieqt:ed8d0bc96fe50697dd0c985449b0f130f280ea5550a8888752240d39060692cd@ec2-54-164-22-242.compute-1.amazonaws.com:5432/d9lcgchif9cln6' # SQL Database URL / Heroku Postgres URL
